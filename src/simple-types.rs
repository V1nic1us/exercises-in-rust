...
pub fn simple_types() {
    ...
    //
    print_difference(coord1, coord2);   // Uncomment and finish this line
    ...
    //
    let coords_arr: [f32; 2] = [coord1, coord2];               // create an array literal out of parts of `coord` here
    ...
    let coords:(f32, f32) = (coord1, coord2);
